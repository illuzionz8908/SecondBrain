...
export function Card({ title, link, type, filePath, fileName, fileSize, mimeType }: CardProps) {
                ...
                <div className="flex justify-between items-start gap-4 mb-3">
                    <div className="flex gap-2.5 items-center min-w-0">
                        ...
                        <div className="min-w-0">
                            <h3 className="text-sm font-medium text-slate-800 truncate" title={title}>
                                {title}
                            </h3>
                            {fileName && (
                                <p className="text-xs text-slate-400 truncate" title={fileName}>
                                    {fileName}
                                </p>
                            )}
                        </div>
    ...
    // ─── YouTube / Twitter Cards (existing code) ────────────────────────────────
    return (
        <div className="group flex flex-col justify-between p-5 bg-white rounded-xl border border-slate-100 
            shadow-[0_2px_8px_rgba(0,0,0,0.04)] hover:shadow-[0_12px_24px_rgba(0,0,0,0.08)] 
            transition-all duration-300 w-full max-w-[320px] min-h-[180px]">
